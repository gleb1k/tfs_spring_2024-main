...
import ru.glebik.tinkoff_fintech.feature.channels.di.ChannelsDeps
import ru.glebik.tinkoff_fintech.feature.chat.di.ChatDeps
import ru.glebik.tinkoff_fintech.feature.people.di.PeopleDeps
import ru.glebik.tinkoff_fintech.feature.profile.di.ProfileDeps
...
import ru.glebik.tinkoff_fintech.main.BottomNavHostFragment
import ru.glebik.tinkoff_fintech.main.MainActivity
import javax.inject.Singleton

@Component(
    modules = [NavigationModule::class, NetworkModule::class,
        DispatchersModule::class, PresentationModule::class,
        DatabaseModule::class, UserModule::class]
)
@Singleton
interface AppComponent : ProfileDeps, PeopleDeps, ChannelsDeps, ChatDeps {
    ...
    fun inject(bottomNavHostFragment: BottomNavHostFragment)
