...
@FeatureScope
class EditMessageContentUseCaseImpl @Inject constructor(
    private val messageRepository: MessageRepository,
) : EditMessageContentUseCase {
    override suspend fun invoke(messageId: Int, newContent: String): ResultWrapper<Message> =
        messageRepository.editMessageContent(messageId, newContent)
}