...
@FeatureScope
class EditMessageTopicUseCaseImpl @Inject constructor(
    private val messageRepository: MessageRepository,
) : EditMessageTopicUseCase {
    override suspend fun invoke(messageId: Int, newTopicName: String): ResultWrapper<Message> =
        messageRepository.editMessageTopic(messageId,newTopicName)
}